...
- The Terra iteration loop's `synthesize.tpl` step renders the same skeleton, which the requester then promotes to the same path.
...
- [ ] 5. Security — <outcome / not applicable>
- [ ] 6. Performance — <outcome>

<!-- trip-init updates this list to match the actual section names/numbers in
the adapted checklist.md, including any project-specific sections inserted at
its [ADAPT_TO_PROJECT] marker. -->
