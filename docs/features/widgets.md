...
Widget code lives in `composeApp/src/androidMain/.../widget/`. `WidgetDataProvider` reads DAOs directly as a boundary exception because widgets need a compact Android-only data source outside normal screen ViewModels.
