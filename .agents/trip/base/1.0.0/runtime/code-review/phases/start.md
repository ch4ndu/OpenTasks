...
1. `docs/ARCHI.md`
2. `.agents/skills/trip-review/checklist.md` — single source of truth for the review checklist, severity classification, and approval gate. Do NOT read `.agents/skills/trip-review/SKILL.md`.
